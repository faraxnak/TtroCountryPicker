#
#  Be sure to run `pod spec lint TtroCountryPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/faraxnak/TtroCountryPicker.git", :tag => "#{s.version}" }
  ...
  # s.resource  = "icon.png"
  s.resources = "TtroCountryPicker/Resources/flags.bundle"
